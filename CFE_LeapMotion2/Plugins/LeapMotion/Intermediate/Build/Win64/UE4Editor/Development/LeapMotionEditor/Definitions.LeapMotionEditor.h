...
#define ORIGINAL_FILE_NAME "UE4Editor-LeapMotionEditor.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME CFE_LeapMotion
...
#define LEAPMOTIONEDITOR_API DLLEXPORT
